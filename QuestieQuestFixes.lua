...
local export = {}
    function export.Load()
        ...
        QuestieDB.questKeys.startedBy = {}
        QuestieDB.questKeys.preQuestGroup = {}
        QuestieDB.questKeys.requiredSourceItems = {}
        QuestieDB.questKeys.specialFlags = {}
        QuestieDB.questKeys.childQuests = {}
        QuestieDB.questKeys.parentQuest = {}
        QuestieDB.questKeys.requiredSkill = {}
        QuestieDB.questKeys.triggerEnd = {}
        QuestieDB.questKeys.requiredRaces = {}
        QuestieDB.questKeys.questLevel = {}
        QuestieDB.questKeys.exclusiveTo = {}
        QuestieDB.questKeys.nextQuestInChain = {}
        QuestieDB.questKeys.inGroupWith = {}
        QuestieDB.questKeys.requiredLevel = {}
        QuestieDB.questKeys.name = {}
        QuestieDB.questKeys.finishedBy = {}
        QuestieDB.questKeys.requiredLevel = {}
        QuestieDB.questKeys.questLevel = {}
        QuestieDB.questKeys.requiredClasses = {}
        QuestieDB.questKeys.objectivesText = {}
        QuestieDB.questKeys.objectives = {}
        QuestieDB.questKeys.sourceItemId = {}
        QuestieDB.questKeys.zoneOrSort = {}
